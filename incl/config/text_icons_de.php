...
const TEXT_GLOBAL_GUI_V_CHOOSE              = 'auswählen';
...
define('TEXT_MAIN_GUI_HEADLINE_DEFAULT'     , 'Die 10 neusten ' . mb_ucfirst(TEXT_GLOBAL_GUI_N_FILM_PL));
...
define('TEXT_MAIN_GUI_MSG_FILMFOUND'        , '%d '. mb_ucfirst(TEXT_GLOBAL_GUI_N_FILM_PL) . ' Gefunden');
...
define('TEXT_FILMEDIT_GUI_HEADLINE_UPDATE'  , mb_ucfirst(TEXT_GLOBAL_GUI_N_FILM_SG) . TEXT_GLOBAL_GUI_V_EDIT . ' <br><small>%s</small>');
define('TEXT_FILMEDIT_GUI_DROPDOWN_DEFAULT' , 'Bitte ' . TEXT_GLOBAL_GUI_V_CHOOSE);
